...
```
Diamons were suggested by `[VEAF]Zip` due to bug in DCS (as of 2.7.4) that may lead to client crash when circles are enabled.
Default was changed to Diamond for that reason.
